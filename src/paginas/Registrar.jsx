...
const Registrar = () => {
  ...
  return (
    <>
        <h1 className='text-yellow-500 font-black text-6xl capitalize flex flex-col'>Crea tu cuenta y administra tus proyectos con <span className='text-slate-700 pt-4'> APPMERN</span></h1>
        ...
        <form 
            ...
            <div className='my-5'>
                ...
                <input
                    id='password'
                    type= 'password'
                    placeholder= 'Password de Registro'                    className= 'w-full mt-3 p-3 border rounded-xl bg-gray-50'  
                    value= {password}    
            ...
            <div className='my-5'>
                ...
                <input
                    id='password2'
                    type= 'password'
                    placeholder= 'Repetir tu Contraseña'                    className= 'w-full mt-3 p-3 border rounded-xl bg-gray-50'
