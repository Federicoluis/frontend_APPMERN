  ...
  return (
    <>
        ...
        <nav className='lg:flex lg:justify-between'>
            <Link
                className='block text-center my-5 text-slate-500 uppercase text-sm hover:text-yellow-500'
                to='registrar'
            >¿No tienes una cuenta? Regístrate</Link> 

            <Link
                className='block text-center my-5 text-slate-500 hover:text-yellow-500 uppercase text-sm'
                to='olvide-password'
